...
const tablesSchema = __schema({
  caption: __table({
    name: 'caption',
    indexes: [
      { accessor: 'id', name: 'caption_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'caption_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, CaptionRow),
  ...
  mood_word: __table({
    name: 'mood_word',
    indexes: [
      { accessor: 'id', name: 'mood_word_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'mood_word_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, MoodWordRow),
  poll: __table({
    name: 'poll',
  ...
  poll_vote: __table({
    name: 'poll_vote',
    indexes: [
      { accessor: 'id', name: 'poll_vote_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'poll_vote_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, PollVoteRow),
  question: __table({
    name: 'question',
  ...
  question_upvote: __table({
    name: 'question_upvote',
    indexes: [
      { accessor: 'id', name: 'question_upvote_id_idx_btree', algorithm: 'btree', columns: [
        'id',
      ] },
    ],
    constraints: [
      { name: 'question_upvote_id_key', constraint: 'unique', columns: ['id'] },
    ],
  }, QuestionUpvoteRow),
  session: __table({
    name: 'session',
